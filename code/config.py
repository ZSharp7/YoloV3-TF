...
__M.Main.classes = './data/classes/Men-s_T-shirts__cls.names'
__M.Main.anchors = './data/anchors/anchors2.txt'
__M.Main.strides = [8,16,32]
__M.Main.backbone = 1# 0:darknet53, 1:mobilenet_v1
...
# __M.Train.sample_num = len(os.listdir(__M.Train.xml))
